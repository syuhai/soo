...
import sooyu.webview.Utils.CXWebChromeClient;
...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	private CXWebChromeClient defaultWebChromeClient;
	...
	private void initWebChromeClient(Context context){
		if(null==defaultWebChromeClient){
			defaultWebChromeClient = new CXWebChromeClient(context, this);
		}
	}
